...
WebUI.setText(findTestObject('search_section/input_origin'), 'Purwokerto')

WebUI.verifyElementPresent(findTestObject('search_section/origin_text_no_result'), 0, FailureHandling.OPTIONAL)
