...
WebUI.click(findTestObject('search_section/seat_business'))
...
WebUI.verifyMatch(url, '^https://www.traveloka.com/en-id/flight/fullsearch?.*', true, FailureHandling.STOP_ON_FAILURE)
